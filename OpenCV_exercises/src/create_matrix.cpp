...
void createMatrix1()
{
    ...
    cv::Mat m1_8u;
    m1_8u.create(nrows, ncols, CV_8UC1); // 2d matrix with 8bit unsigned elements one channel
    ...
    m3_8u.create(nrows, ncols, CV_8UC3); // 2d matrix with 8bit unsigned elements 3 channels 
