...
void showLidarTopview()
{
    ...
    for (auto it = lidarPoints.begin(); it != lidarPoints.end(); ++it)
    {
        ...
        int y = (-xw * imageSize.height / worldSize.height) + imageSize.height;  //convert sensor data location into pixel location
        ...
        if(zw > -1.40){ //points below ground plane is ignored
        // EOF STUDENT EXERCISE 2            

            // STUDENT EXERCISE 1
            float val = it->x;  //color code the lidar point based on the distance
